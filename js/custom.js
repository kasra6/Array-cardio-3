// Get your shorts on - this is an array workout!
    ...
    const inventors1500 = inventors.filter(inventor => inventor.year >= 1500
      && inventor.year <1600);
    ...
    // Array.prototype.map()
      ...
      const inventorFullName =  inventors.map(inventor =>
    ...
    const inventorsOldest = inventors.sort((a, b) => a.year > b.year ? 1 : -1);

    console.table(inventorsOldest);

    // Array.prototype.reduce()
    // 4. How many years did all the inventors live all together?

    let sum = inventors.reduce((total, inventor) => {
    ...
    const inventorsLongestLived = inventors.sort((a, b) => {
      const aAge = a.passed - a.year;
      const bAge = b.passed - b.year;
      return (aAge > bAge ? -1 : 1);
    });

    console.table(inventorsLongestLived);
    ...
    // name
      ...
      // const linksParent = document.querySelector(".mw-category");
      // const links = linksParent.querySelectorAll("a");
      //
      // const deBoulvards = Array.from(links)
      //                     .map(link => link.textContent)
      //                     .filter(link => link.includes('de'));
      //
      // console.log(deBoulvards);
    ...
    // const namesAlpha = people.sort((a, b) => {
    //   const [aLast, aFirst] = a.split(", ");
    //   const [bLast, bFirst] = b.split(", ");
    //   return aLast > bLast ? 1 : -1;
    // });
    // console.log(namesAlpha);

    // const parts = people.split(", ");
    // consol.log(parts);
    // const peopleByName = people.sort((a, b) => {
    //   const [aName, aLastname] = a.name a.lastname;
    //   const [bName, bLastname] = b.name b.lastname;
    //   return ()
    // })
    ...
    'bike', 'walk', 'car', 'van', 'car', 'truck', 'house' ];
